...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="#" style="text-align: center " align="center">WEB PROGRAMMING 2</a>
    ...
    <div class="container" style="margin-top:20px">
        ...
        <hr>
        <hr>
        <button class="btn btn-warning" onclick="window.location.href='Tambah.php'" > Tambah Baru </button>
        <br>
        <br>
